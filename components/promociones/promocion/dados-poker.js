...
function sliderPromo3(){

  const sliderTracklamp = document.getElementById("sliderTrackdados");
  const slideslamp = document.querySelectorAll(".slidedados");
  const btnPrevlamp = document.getElementById("btn-prevdados");
  const btnNextlamp = document.getElementById("btn-nextdados");
  const dotsContainerlamp = document.getElementById("dotsdados");
  ...
  function updateSlider() {
    ...
    document.querySelectorAll(".dotdados").forEach((dot, i) => {
